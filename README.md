...
В проекте настроена система мониторинга Prometheus для сервисов, UI развернут на порту `9090`

## Grafana

Вместе с остальными сервисами разворачивается система визуализации и анализа данных Grafana, которая доступна на `3333` порту (данные для входа admin:admin)
